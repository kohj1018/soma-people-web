...
export const postCSContent = (csType: CsType, userId: number, nickname: string = 'nickname', content: string, reportTargetType: ReportType = 'NotReport', reportTargetId: number = 0) => base('customer-service').create([
    {
        "fields": {
            "csType": csType,
