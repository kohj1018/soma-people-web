...
const AddPost: NextPage = () => {
  ...
  const postMutation = useMutation(addPost, {
    onSuccess: () => {
      queryClient.invalidateQueries([INFINITE_POST_INFO_LIST, boardId, userInfo?.userId])
        .then(() => {
  ...
  return (
    <MainContainer>
      ...
      <MainArea className='px-5'>
        ...
        />
        <textarea
          className='mt-6 w-full h-[65vh] text-base font-normal text-gray-700 placeholder:text-gray-400 focus:outline-none hide-scrollbar'
