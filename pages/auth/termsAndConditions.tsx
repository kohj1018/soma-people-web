    ...
    <MainContainer>
      <main className='relative min-h-screen pt-10 px-5 lg:pt-28'>
        ...
        <section className='mt-8 space-y-6 lg:mt-12 lg:space-y-9'>
          <article className='space-y-3.5 lg:space-y-5'>
            <div className='flex items-center justify-between'>
              <p className='text-sm font-semibold text-gray-900 lg:text-lg'><span className='text-blue-500'>(필수) </span>소마인서비스이용약관</p>
              <button
                onClick={() => setAgreeTerms(!agreeTerms)}
                className={'w-5 h-5 flex items-center justify-center rounded-full border-2 lg:w-8 lg:h-8'
                  + (agreeTerms ? ' bg-blue-500 border-blue-500' : ' bg-gray-200 border-gray-200')}
              >
          ...
          <article className='space-y-3.5 lg:space-y-5'>
            <div className='flex items-center justify-between'>
              <p className='text-sm font-semibold text-gray-900 lg:text-lg'><span className='text-blue-500'>(필수) </span>개인정보처리방침</p>
              <button
                onClick={() => setAgreePolicy(!agreePolicy)}
                className={'w-5 h-5 flex items-center justify-center rounded-full border-2 lg:w-8 lg:h-8'
                  + (agreePolicy ? ' bg-blue-500 border-blue-500' : ' bg-gray-200 border-gray-200')}
              >
                <Check className='w-3 h-3 text-white lg:w-4 lg:h-4' />
              </button>
            </div>
        ...
        {agreeTerms && agreePolicy &&
          <Link href='/auth/signUp' className='absolute left-5 right-5 bottom-8 py-4 rounded-lg bg-blue-500 shadow-button text-center text-base font-bold text-gray-50 lg:moveToXAxisCenter lg:w-[50rem]'>
            다음
          </Link>
        }
      </main>
...
const terms = <>
  <h3>제1조(목적)</h3>
  <p>소마인 서비스 이용약관은 소마인(이하 &quot;회사&quot;라 합니다)가 제공하는 소마인 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.</p>
  ...
  <ol>
    ...
    <ol>
      ...
      <li>&quot;소마인&quot;, &quot;SW 마에스트로 구성원&quot;이란, 소프트웨어 마에스트로 프로그램에 선발되어 활동하거나 활동한 멘토, 연수생, 수료생과 프로그램을 운영하는 사무국 등 해당 프로그램에 관련된 이용자들을 말합니다.</li>
      <li>&quot;준비생&quot;이란, SW 마에스트로 선발을 위해 준비하는 이용자들을 말합니다.</li>
      <li>&quot;게시물&quot;이란, 서비스에 게재된 문자, 사진, 영상, 첨부파일, 광고 등을 말합니다.</li>
      <li>&quot;커뮤니티&quot;란, 게시물을 게시할 수 있는 공간을 말합니다.</li>
      <li>&quot;이용 기록&quot;이란, 이용자가 서비스를 이용하면서 직접 생성한 게시글, 댓글, 채팅, 기타 정보 등을 말합니다.</li>
      ...
      <li>&quot;소마인 인증&quot;이란, 소마 홈페이지 캡처 사진 등을 이용한 SW 마에스트로 구성원 확인 절차를 말합니다.</li>
    </ol>
  ...
  <ol>
    ...
    <ol>
      <li>SW 마에스트로 구성원들과 네트워킹 할 수 있는 커뮤니티 서비스</li>
      <li>SW 마에스트로 준비생들을 위한 질문 답변 서비스</li>
      <li>기타 회사가 정하는 서비스</li>
    </ol>
    <li>소마인은 SW 마에스트로 구성원으로 인증받은 이용자가 모든 서비스를 이용할 수 있는 인증형 서비스입니다. 소마인 인증을 받지 않은 이용자 및 불특정 다수의 일반 이용자는 커뮤니티를 포함한 대부분의 기능에 접근할 수 없습니다.</li>
  ...
  <ol>
    ...
    <li>회사는 부정사용방지 및 본인확인을 위해 회원에게 본인 인증 및 소마인 인증을 요청할 수 있습니다.</li>
  ...
  <ol>
    ...
    <li>회원의 아이디, 비밀번호, 이메일, 소마인 정보 등 모든 개인정보의 관리책임은 본인에게 있으므로, 타인에게 양도 및 대여할 수 없으며 유출되지 않도록 관리해야 합니다. 만약 본인의 아이디 및 비밀번호를 타인이 사용하고 있음을 인지했을 경우, 즉시 문의 창구로 알려야 하고, 안내가 있는 경우 이에 따라야 합니다.</li>
  ...
  <h3>제9조(저작권의 귀속)</h3>
  <ol>
    <li>회사는 유용하고 편리한 서비스를 제공하기 위해, 2023년부터 서비스 및 서비스 내부의 기능(커뮤니티 기능의 게시판 등)의 체계와 다양한 기능을 직접 설계 및 운영하고 있는 데이터베이스 제작자에 해당합니다. 회사는 저작권법에 따라 데이터베이스 제작자는 복제권 및 전송권을 포함한 데이터베이스 전부에 대한 권리를 가지고 있으며, 이는 법률에 따라 보호를 받는 대상입니다. 그러므로 이용자는 데이터베이스 제작자인 회사의 승인 없이 데이터베이스의 전부 또는 일부를 복제·배포·방송 또는 전송할 수 없습니다.</li>
  ...
  <ol>
    ...
    <ol>
      ...
      <ol>
        ...
        <li>계정 판매 및 공유, 대리 게시 등을 통해 여러 게시판에 다발적으로 게시되는 동일한 주제에 대한 직·간접적 홍보 행위</li>
      ...
      <li>시스템 부정행위</li>
      <ol>
        <li>SW 마에스트로 구성원이 아닌 이용자가 SW 마에스트로 구성원인 것처럼 기만하여 서비스를 이용하는 행위</li>
  ...
  <ol>
    <li>이용자가 이 약관 및 커뮤니티 이용규칙에서 이 조항 적용이 명시된 금지행위 및 이에 준하는 행위를 할 경우, 회사는 서비스 보호를 위해 다음과 같은 조치를 최대 영구적으로 취할 수 있습니다.</li>
    <ol>
      <li>회원의 서비스 이용 권한, 자격, 혜택 제한 및 회수</li>
      <li>회원과 체결된 이용계약의 해지</li>
      <li>회원가입, 본인 인증, 소마인 인증 거부</li>
  ...
  <h3>제15조(기타)</h3>
  <ol>
    <li>이 약관은 2023년 2월 17일에 처음 작성되었습니다.</li>
...
const policy = <>
  <h3>1. 개인정보 처리방침</h3>
  <p>개인정보 처리방침은 소마인(이하 &quot;회사&quot;라 합니다)가 특정한 가입절차를 거친 인증형 서비스를 제공함에 있어, 개인정보를 어떻게 수집·이용·보관·파기하는지에 대한 정보를 담은 방침을 의미합니다. 개인정보 처리방침은 개인정보보호법 등 국내 개인정보 보호 법령을 모두 준수하고 있습니다. 본 개인정보 처리방침에서 정하지 않은 용어의 정의는 서비스 이용약관을 따릅니다.</p>

  <h3>2. 수집하는 개인정보의 항목</h3>
  <p>회사는 서비스 제공을 위해 다음 항목 중 최소한의 개인정보를 수집합니다.</p>

  <h4>1) 회원가입 시 수집되는 개인정보</h4>
  <p>이름, 회원유형(멘토, 연수생, 수료생, 준비생 등), 기수, OAuth 아이디</p>

  <h4>2) 별도로 수집되는 개인정보</h4>
  <ol>
    <li>소마인 인증을 할 경우</li>
    <ol>
      <li>마스킹 된 증빙 자료 사본(소프트웨어 마에스트로 홈페이지 스크린샷, 기타 증빙할 수 있는 첨부 자료)</li>
    </ol>

    <li>프로필 사진을 지정할 경우</li>
    <ol>
      <li>프로필 사진</li>
    </ol>

    <li>이벤트·행사 참여를 할 경우</li>
    <ol>
    ...
    <li>문의를 할 경우</li>
    <ol>
      <li>회원정보, 기기정보, 문의내용에 포함된 개인정보</li>
    </ol>

    <li>제휴·광고·교내단체·게시 요청을 할 경우</li>
    <ol>
      <li>단체명, 대표자·담당자 정보(이름, 이메일, 전화번호, 직책)</li>
    </ol>

    <li>게시 중단 요청을 할 경우</li>
    <ol>
      <li>요청인·대리인 정보(이름·단체명, 생년월일·설립일, 마스킹 된 신분증 사본, 연락처, 이메일, 증빙 자료 사본)</li>
    </ol>
  </ol>
  <p> ※ 각 항목 또는 추가적으로 수집이 필요한 개인정보 및 개인정보를 포함한 자료는 이용자 응대 과정과 서비스 내부 알림 수단 등을 통해 별도의 동의 절차를 거쳐 요청·수집될 수 있습니다.<br/>
    ※ 서비스 이용 과정에서 기기 정보(유저 에이전트), 이용 기록(전공 질문 및 답변), 로그 기록(IP 주소, 접속 시간)이 자동으로 수집될 수 있습니다.</p>

  <h3>3. 수집한 개인정보의 처리 목적</h3>
  <p>수집된 개인정보는 다음의 목적에 한해 이용됩니다.</p>
  <ol>
    <li>가입 및 탈퇴 의사 확인, 회원 식별, SW 마에스트로 구성원 확인 등 회원 관리</li>
    <li>이용자 맞춤형 서비스 제공(서비스 내부 광고 포함) 및 기존·신규 시스템 개발·유지·개선</li>
    <li>불법·약관 위반 게시물 게시 등 부정행위 방지를 위한 운영 시스템 개발·유지·개선</li>
    <li>문의, 제휴 문의, 광고 문의, 게시 요청, 교내단체 게시판 개설 요청 관련 응대 및 처리</li>
  </ol>

  <h3>4. 개인정보의 제3자 제공</h3>
  <p>회사는 회원의 개인정보를 제3자에게 제공하지 않습니다. 단, 다음의 사유가 있을 경우 제공할 수 있습니다.</p>
  <ol>
    <li>회원이 제휴사의 서비스를 이용하기 위해 개인정보 제공을 회사에 요청할 경우</li>
  ...
  <h3>5. 개인정보 처리의 위탁</h3>
  <p>회사는 원활한 개인정보 업무처리와 보안성 높은 서비스 제공을 위하여, 신뢰도가 검증된 다음 회사 및 서비스에 개인정보 관련 업무 처리를 위탁하고 있습니다. 위탁계약 체결 시 회사는 기술적·관리적 보호조치 등 수탁자에 대한 관리·감독을 하고 있습니다.</p>
  <ol>
    <li>Amazon Web Services, Inc. : 서비스 시스템 제공, 데이터 관리 및 보관</li>
    <li>AirTable, Inc. : 문의, 건의, 신고, 소마인 인증 데이터 관리 및 보관</li>
  </ol>

  <h3>6. 수집한 개인정보의 보관 및 파기</h3>
  <p>회사는 서비스를 제공하는 동안 개인정보 처리방침 및 관련법에 의거하여 회원의 개인정보를 지속적으로 관리 및 보관합니다. 탈퇴 등 개인정보 수집 및
    이용목적이 달성될 경우, 수집된 개인정보는 즉시 또는 다음과 같이 일정 기간 이후 파기됩니다.</p>
  <ol>
    <li>가입 및 소마인 인증 시 수집된 개인정보 : 탈퇴 후 14일</li>
    <li>제휴·광고·이벤트 관련 요청 응대 및 처리 자료 : 3개월</li>
    <li>소마인 인증 요청 자료 : 3개월</li>
    <li>게시요청 관리자 정보 : 마지막 접속일로부터 2년</li>
    <li>기기 정보 및 로그 기록 : 최대 1년</li>
    <li>문의 및 응대 기록 : 3년</li>
  </ol>
  <p> ※ 위 항에도 불구하고 법령에 의해 개인정보를 보존해야 하는 경우, 해당 개인정보는 물리적·논리적으로 분리하여 해당 법령에서 정한 기간에 따라 저장합니다.<br/> ※ 회원 탈퇴, 보관 기한 만료 등
    파기 사유가 발생한 개인정보는 재생이 불가능한 방법으로 파기됩니다. 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록·저장된 개인정보는 분쇄기로 분쇄하거나
    소각하여 파기합니다.<br/> ※ 회원이 1년 이상 로그인 및 접속을 하지 않을 경우, 해당 계정은 휴면 계정으로 전환됩니다. 이후에도 3년 동안 로그인을 하지 않을 경우, 해당 계정은 영구 삭제됩니다.
    <br/> ※ 부정행위 시, 제재 및 제재 내역 확인을 위해 IP, 게시물, 회원번호, 비식별화한 정보(소마인 정보, 연계정보)를 이용제한 종료일로부터 1년 동안 보관합니다.</p>

  <h3>7. 정보주체의 권리, 의무 및 행사</h3>
  <p>회원은 언제든지 서비스 내부 [내 정보] 또는 문의하기를 통해 자신의 개인정보를 조회하거나 수정, 삭제, 탈퇴를 할 수 있습니다.</p>

  <h3>8. 쿠키</h3>
  <p>쿠키란 웹사이트를 운영하는 데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 서비스는 사이트 로그인을 위해 아이디 식별에 쿠키를 사용할 수 있습니다.</p>
  <p>쿠키 설정 거부 방법 예시</p>
  <ol>
    <li>Internet Explorer : 웹 브라우저 상단의 도구 &gt; 인터넷 옵션 &gt; 개인정보 &gt; 설정</li>
    <li>Chrome : 웹 브라우저 우측의 설정 &gt; 고급 설정 표시 &gt; 개인정보의 콘텐츠 설정 버튼 &gt; 쿠키</li>
  </ol>

  <h3>9. 개인정보에 관한 책임자 및 서비스</h3>
  <p>회사는 회원의 개인정보를 최선으로 보호하고 관련된 불만을 처리하기 위해 정보보호팀을 운영하고 있습니다.</p>
  <ol>
    <li>개인정보보호 담당 부서 : 소마인 정보보호팀</li>
    <li>소마인 정보보호팀 이메일 : somapeople.official@gmail.com</li>
  </ol>
  <p>※ 서비스 이용, 접근 제한 등의 문의는 위 창구를 통해 처리되지 않습니다.</p>

  <p>기타 개인정보 침해에 대한 신고나 상담이 필요하신 경우에는 다음 기관에 문의하시기 바랍니다.</p>
  <ol>
    <li>개인정보 분쟁조정위원회 : <a href="https://www.kopico.go.kr">https://www.kopico.go.kr</a></li>
    <li>사이버범죄 신고시스템 : <a href="https://ecrm.police.go.kr">https://ecrm.police.go.kr</a></li>
  </ol>

  <h3>10. 기타</h3>
  <p>이 개인정보 처리방침은 2023년 2월 17일 처음 작성되었습니다.</p>
</>